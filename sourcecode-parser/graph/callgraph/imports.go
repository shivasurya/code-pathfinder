...
func traverseForImports(node *sitter.Node, sourceCode []byte, importMap *ImportMap, filePath string, registry *ModuleRegistry) {
	if node == nil {
		return
	}
...
func processImportFromStatement(node *sitter.Node, sourceCode []byte, importMap *ImportMap, filePath string, registry *ModuleRegistry) {
...
func resolveRelativeImport(filePath string, dotCount int, moduleSuffix string, registry *ModuleRegistry) string {
