...
func (l *StdlibRegistryLoader) loadManifestFromFile(path string) (*Manifest, error) {
...
func (l *StdlibRegistryLoader) loadModuleFromFile(path string) (*StdlibModule, error) {
	data, err := os.ReadFile(path)
	if err != nil {
