...
func (br *BuiltinRegistry) initStringType() {
	...
	for _, method := range stringReturnMethods {
		strType.Methods[method] = &BuiltinMethod{
			Name:       method,
			ReturnType: &TypeInfo{TypeFQN: "builtins.str", Confidence: 1.0, Source: "builtin"},
		}
	}
	...
	for _, method := range boolReturnMethods {
		strType.Methods[method] = &BuiltinMethod{
			Name:       method,
			ReturnType: &TypeInfo{TypeFQN: "builtins.bool", Confidence: 1.0, Source: "builtin"},
		}
	}
	...
	for _, method := range intReturnMethods {
		strType.Methods[method] = &BuiltinMethod{
			Name:       method,
			ReturnType: &TypeInfo{TypeFQN: "builtins.int", Confidence: 1.0, Source: "builtin"},
		}
	}
	...
	for _, method := range listReturnMethods {
		strType.Methods[method] = &BuiltinMethod{
			Name:       method,
			ReturnType: &TypeInfo{TypeFQN: "builtins.list", Confidence: 1.0, Source: "builtin"},
		}
	}
	...
	strType.Methods["encode"] = &BuiltinMethod{
		Name:       "encode",
		ReturnType: &TypeInfo{TypeFQN: "builtins.bytes", Confidence: 1.0, Source: "builtin"},
	}
...
func (br *BuiltinRegistry) initListType() {
	...
	for _, method := range noneMethods {
		listType.Methods[method] = &BuiltinMethod{
			Name:       method,
			ReturnType: &TypeInfo{TypeFQN: "builtins.NoneType", Confidence: 1.0, Source: "builtin"},
		}
	}
	...
	// pop returns the element (unknown type, use confidence 0.5)
	listType.Methods["pop"] = &BuiltinMethod{
		Name:       "pop",
		ReturnType: &TypeInfo{TypeFQN: "", Confidence: 0.0, Source: "builtin"},
	}
...
func (br *BuiltinRegistry) initDictType() {
	...
	dictType.Methods["keys"] = &BuiltinMethod{
		Name:       "keys",
		ReturnType: &TypeInfo{TypeFQN: "builtins.dict_keys", Confidence: 1.0, Source: "builtin"},
	}
	dictType.Methods["values"] = &BuiltinMethod{
		Name:       "values",
		ReturnType: &TypeInfo{TypeFQN: "builtins.dict_values", Confidence: 1.0, Source: "builtin"},
	}
	dictType.Methods["items"] = &BuiltinMethod{
		Name:       "items",
		ReturnType: &TypeInfo{TypeFQN: "builtins.dict_items", Confidence: 1.0, Source: "builtin"},
	}

	// copy returns dict
	dictType.Methods["copy"] = &BuiltinMethod{
		Name:       "copy",
		ReturnType: &TypeInfo{TypeFQN: "builtins.dict", Confidence: 1.0, Source: "builtin"},
	}
	...
	dictType.Methods["popitem"] = &BuiltinMethod{
		Name:       "popitem",
		ReturnType: &TypeInfo{TypeFQN: "builtins.tuple", Confidence: 0.5, Source: "builtin"},
	}
...
func (br *BuiltinRegistry) initSetType() {
	...
	for _, method := range setReturnMethods {
		setType.Methods[method] = &BuiltinMethod{
			Name:       method,
			ReturnType: &TypeInfo{TypeFQN: "builtins.set", Confidence: 1.0, Source: "builtin"},
		}
	}
...
func (br *BuiltinRegistry) initFloatType() {
	...
	for _, method := range floatReturnMethods {
		floatType.Methods[method] = &BuiltinMethod{
			Name:       method,
			ReturnType: &TypeInfo{TypeFQN: "builtins.float", Confidence: 1.0, Source: "builtin"},
		}
	}
