...
`
	...
	targetFQN, resolved, _ := resolveCallTarget("models.User", importMap, registry, modulePath, codeGraph, nil, "")
	...
	targetFQN, resolved, _ = resolveCallTarget("serializers.ModelSerializer", importMap, registry, modulePath, codeGraph, nil, "")
	...
	targetFQN, resolved, _ = resolveCallTarget("pytest.fixture", importMap, registry, modulePath, codeGraph, nil, "")
	...
	targetFQN, resolved, _ = resolveCallTarget("json.loads", importMap, registry, modulePath, codeGraph, nil, "")
	assert.True(t, resolved, "json.loads should be resolved")
	assert.Equal(t, "json.loads", targetFQN)

	// Test logging (stdlib) resolution
	targetFQN, resolved, _ = resolveCallTarget("logging.getLogger", importMap, registry, modulePath, codeGraph, nil, "")
...
`
	...
	targetFQN, resolved, _ := resolveCallTarget("sanitize", importMap, registry, modulePath, codeGraph, nil, "")
	assert.True(t, resolved, "Local function sanitize should be resolved")
	assert.Contains(t, targetFQN, "utils.sanitize")

	targetFQN, resolved, _ = resolveCallTarget("validate", importMap, registry, modulePath, codeGraph, nil, "")
...
`
	...
	targetFQN, resolved, _ := resolveCallTarget("loads", importMap, registry, modulePath, codeGraph, nil, "")
...
`
	...
	targetFQN, resolved, _ := resolveCallTarget("helper", importMap, registry, modulePath, codeGraph, nil, "")
