...
func TestIsRuleID(t *testing.T) {
	tests := []struct {
		...
		{name: "valid three-part PYTHON-FLASK-SEC-003", input: "PYTHON-FLASK-SEC-003", want: true},
		{name: "valid three-part PYTHON-DJANGO-SEC-001", input: "PYTHON-DJANGO-SEC-001", want: true},
		{name: "valid three-part PYTHON-LANG-SEC-001", input: "PYTHON-LANG-SEC-001", want: true},
		{name: "valid four-part PYTHON-FLASK-AUDIT-003", input: "PYTHON-FLASK-AUDIT-003", want: true},
		{name: "valid with suffix letter", input: "PYTHON-CRYPTO-SEC-001a", want: true},
