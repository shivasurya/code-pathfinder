...
Browse our specialized collection of Android WebView security rules designed to detect common vulnerabilities in WebView implementations. Our rules focus on two key OWASP Mobile Top 10 categories: M7 (Client Code Quality) for JavaScript-related risks and M1 (Improper Platform Usage) for access control issues. All rules target CWE-079 (Cross-site Scripting) vulnerabilities with medium precision.
...
<RuleSearch placeholder="Search security rules..." />
...
<div class="rule-card" data-severity="medium" data-type="security" data-owasp="improper-platform-usage">
  <Card title="WebView Content Access" icon="warning">
      ...
      **Severity: Medium** | **Security-Severity: 6.1** | **CWE: 079**  
